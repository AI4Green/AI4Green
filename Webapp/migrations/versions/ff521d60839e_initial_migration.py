...
Revision ID: ff521d60839e
Revises: 
Create Date: 2023-06-30 15:46:01.777967
...
def upgrade():
    ...
    with op.batch_alter_table('Compound', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_Compound_solvent'), ['solvent'], unique=False)
    ...
    with op.batch_alter_table('Notification', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_Notification_person'), ['person'], unique=False)
    ...
    with op.batch_alter_table('WorkGroup', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_WorkGroup_institution'), ['institution'], unique=False)

    op.create_table('CompoundDataErrorReport',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('CompoundDataErrorReport', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_CompoundDataErrorReport_compound'), ['compound'], unique=False)

    op.create_table('Person_WorkGroup',
    sa.Column('person', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('Person_WorkGroup', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_Person_WorkGroup_workgroup'), ['workgroup'], unique=False)

    op.create_table('Person_WorkGroup_2',
    sa.Column('person', sa.Integer(), nullable=False),
    sa.Column('workgroup', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['person'], ['Person.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['workgroup'], ['WorkGroup.id'], ondelete='CASCADE'),
    ...
    with op.batch_alter_table('Person_WorkGroup_2', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_Person_WorkGroup_2_workgroup'), ['workgroup'], unique=False)

    op.create_table('Person_WorkGroup_3',
    sa.Column('person', sa.Integer(), nullable=False),
    sa.Column('workgroup', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['person'], ['Person.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['workgroup'], ['WorkGroup.id'], ondelete='CASCADE'),
    ...
    with op.batch_alter_table('Person_WorkGroup_3', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_Person_WorkGroup_3_workgroup'), ['workgroup'], unique=False)

    op.create_table('WGStatusRequest',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.Column('status', sa.Text(), nullable=False),
    sa.ForeignKeyConstraint(['notification'], ['Notification.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['person'], ['Person.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['principal_investigator'], ['Person.id'], ondelete='CASCADE'),
    ...
    with op.batch_alter_table('WGStatusRequest', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_WGStatusRequest_notification'), ['notification'], unique=False)
        batch_op.create_index(batch_op.f('ix_WGStatusRequest_person'), ['person'], unique=False)
        batch_op.create_index(batch_op.f('ix_WGStatusRequest_principal_investigator'), ['principal_investigator'], unique=False)
    ...
    op.create_table('WorkGroup_request',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.Text(), nullable=False),
    sa.Column('principal_investigator', sa.Integer(), nullable=False),
    sa.Column('info', sa.Text(), nullable=False),
    ...
    with op.batch_alter_table('WorkGroup_request', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_WorkGroup_request_institution'), ['institution'], unique=False)
        batch_op.create_index(batch_op.f('ix_WorkGroup_request_principal_investigator'), ['principal_investigator'], unique=False)
        batch_op.create_index(batch_op.f('ix_WorkGroup_request_workgroup'), ['workgroup'], unique=False)

    op.create_table('NovelCompound',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.Text(), nullable=False),
    ...
    with op.batch_alter_table('NovelCompound', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_NovelCompound_solvent'), ['solvent'], unique=False)
        batch_op.create_index(batch_op.f('ix_NovelCompound_workbook'), ['workbook'], unique=False)

    op.create_table('Person_WorkBook',
    sa.Column('person', sa.Integer(), nullable=False),
    sa.Column('workbook', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['person'], ['Person.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['workbook'], ['WorkBook.id'], ondelete='CASCADE'),
    ...
    with op.batch_alter_table('Person_WorkBook', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_Person_WorkBook_workbook'), ['workbook'], unique=False)
    ...
    with op.batch_alter_table('Reaction', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_Reaction_creator'), ['creator'], unique=False)

    op.create_table('WBStatusRequest',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('WBStatusRequest', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_WBStatusRequest_notification'), ['notification'], unique=False)
        batch_op.create_index(batch_op.f('ix_WBStatusRequest_person'), ['person'], unique=False)
        batch_op.create_index(batch_op.f('ix_WBStatusRequest_pi_sr'), ['pi_sr'], unique=False)
        batch_op.create_index(batch_op.f('ix_WBStatusRequest_wb'), ['wb'], unique=False)

    op.create_table('ReactionDataFile',
    ...
    with op.batch_alter_table('ReactionDataFile', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_ReactionDataFile_reaction'), ['reaction'], unique=False)

    op.create_table('ReactionNote',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('time_of_creation', sa.DateTime(), nullable=False),
    ...
    with op.batch_alter_table('ReactionNote', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_ReactionNote_author'), ['author'], unique=False)
        batch_op.create_index(batch_op.f('ix_ReactionNote_reaction'), ['reaction'], unique=False)

    op.create_table('Reaction_Reaction',
    sa.Column('reaction', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('Reaction_Reaction', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_Reaction_Reaction_reaction_2'), ['reaction_2'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('ReactionNote', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_ReactionNote_reaction'))
        batch_op.drop_index(batch_op.f('ix_ReactionNote_author'))
