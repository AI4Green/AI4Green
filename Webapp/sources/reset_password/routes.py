from flask import render_template, url_for, redirect, flash  # renders html templates
from sources.reset_password import reset_password_bp  # imports the blueprint of the dummy route
from sources import db  # imports the user database models
from flask_login import current_user, logout_user
from sources.email_methods import send_password_reset_email, verify_reset_password_token  # email methods
from pony.orm import select
from sources.reset_password.forms import ResetPasswordRequestForm, ResetPasswordForm
...
def reset_password_request():
    ...
    if form.validate_on_submit():
        ...
        user = select(u for u in db.User if form.email.data == u.email).first()
