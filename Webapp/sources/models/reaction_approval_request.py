...
reaction_approval_request_approvers = db.Table(
    ...
    db.Column(
        ...
        db.Integer,
        db.ForeignKey("ReactionApprovalRequest.id"),
    ),
...
class ReactionApprovalRequest(Model):
    """
    A reaction approval request is generated by a user for a specific reaction and approved by a Principal Investigator
    """

    __tablename__ = "ReactionApprovalRequest"
