...
def reaction(permission_level: str, async_type: str = "AJAX", request_source="user"):
    """
    ...
    if permission_level == "view_only":
        ...
        edit_reaction(reaction, request_source, file_attachment=True)
...
def edit_reaction(
    ...
    if (
        ...
        and reaction.autogenerated is True
    ):
        abort(401)
    if file_attachment:
        return
