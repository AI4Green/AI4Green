...
def from_primary_key(primary_key: Union[int, Tuple, str]) -> models.Solvent:
    """
    ...
    if services.all_compounds.validate_primary_key(primary_key):
        ...
        if isinstance(primary_key, int):
            solvent = _get_compound_db_solvent(primary_key)
        elif isinstance(primary_key, tuple):
            solvent = _get_novel_compound_db_solvent(primary_key)
    return solvent
