...
# def _get_smiles_novel_compound_db_solvent(primary_key: Tuple) -> Optional[str]:
#     """
...
#
#     Returns:
#          The solvent sustainability flag as an integer.
#     """
#     return (
#         db.session.query(models.Solvent.NovelCompound.smiles)
...
#
#
# def _get_smiles_compound_db_solvent(primary_key: int) -> str:
#     """
#     Gets the solvent sustainability flag for a solvent inside the NovelCompound Table
#     Args:
...
#     """
#     return (
#         db.session.query(models.Solvent.compound[0].smiles)
...
#
# def _get_cas_novel_compound_db_solvent(primary_key: Tuple) -> Optional[str]:
#     """
#     Gets the solvent sustainability flag for a solvent inside the NovelCompound Table
#     Args:
#         primary_key - tuple of novel compound name workbook id
...
#     """
#     return (
#         db.session.query(models.Solvent.NovelCompound.cas)
#         .join(models.NovelCompound)
#         .filter(func.lower(models.NovelCompound.name) == primary_key[0].lower())
#         .join(models.WorkBook)
#         .filter(models.WorkBook.id == primary_key[1])
...
#
#
# def _get_cas_compound_db_solvent(primary_key: int) -> str:
#     """
#     Gets the solvent sustainability flag for a solvent inside the NovelCompound Table
#     Args:
#         primary_key: autogenerated primary id key for the compound table for the solvent.
...
#     """
#     return (
#         db.session.query(models.Solvent.compound[0].cas)
#         .join(models.Compound)
#         .join(models.Compound)
#         .filter(models.Compound.id == primary_key)
#         .scalar()
