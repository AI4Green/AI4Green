...
def delete_file_attachment(user_request: bool, file_uuid: str = None):
    """
    Delete file attached to reaction from storage and reference in database

    Args:
        user_request: True if the request came from a user. False if from autogenerated PDF logic
    ...
    # user cannot delete autogenerated object
    if user_request is True and file_object.autogenerated is True:
        abort(401)
        ...
        for file in file_attachments:
            if file.autogenerated:
                ...
                services.file_attachments.delete_file_attachment(
                    user_request=False, file_uuid=file.uuid
                )
