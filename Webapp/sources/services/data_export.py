...
class ReactionMetaData:
    ...
    def read_time_of_creation(self):
        ...
        return self.db_reaction.time_of_creation
    ...
    def read_solvent_sustainability(self) -> Optional[List[str]]:
        ...
        sustainability_flags = [
            ReactionDataReplacement.solvent_sustainability(
    ...
    def read_element_sustainability(self) -> Optional[str]:
        ...
        return ReactionDataReplacement.element_sustainability(
    ...
    def read_purification_method(self) -> Optional[str]:
        ...
        return ReactionDataReplacement.isolation(
    ...
    def read_atom_economy(self) -> Optional[str]:
        ...
        """
        return self.exported_from_js.get("Atom Efficiency")
    ...
    def read_mass_efficiency(self) -> str:
        ...
        """
        return self.summary_data.get("mass_efficiency")
    ...
    def read_conversion(self) -> Optional[str]:
        return self.summary_data.get("conversion")

    def read_selectivity(self):
        return self.summary_data.get("selectivity")

    def read_sustainability_flags(self) -> Dict:
        return {
            "temperature_flag": ReactionDataReplacement.css_classes_to_chem21_colour_flag(
                self.exported_from_js.get("Temperature Sustainability")
            ),
            "element_sustainability_flag": ReactionDataReplacement.css_classes_to_chem21_colour_flag(
                self.exported_from_js.get("Elements Sustainability")
            ),
            "batch_or_flow_flag": ReactionDataReplacement.css_classes_to_chem21_colour_flag(
                self.exported_from_js.get("Batch or Flow Sustainability")
            ),
            "isolation_flag": ReactionDataReplacement.css_classes_to_chem21_colour_flag(
                self.exported_from_js.get("Isolation Sustainability")
            ),
            "catalyst_used_flag": ReactionDataReplacement.css_classes_to_chem21_colour_flag(
                self.exported_from_js.get("Catalyst Sustainability")
            ),
            "catalyst_recovery_flag": ReactionDataReplacement.css_classes_to_chem21_colour_flag(
                self.exported_from_js.get("Recovery Sustainability")
            ),
            "atom_economy_flag": ReactionDataReplacement.css_classes_to_chem21_colour_flag(
                self.exported_from_js.get("Atom Economy Sustainability")
            ),
            "mass_efficiency_flag": ReactionDataReplacement.css_classes_to_chem21_colour_flag(
                self.exported_from_js.get("Mass Efficiency Sustainability")
            ),
            "yield_flag": ReactionDataReplacement.css_classes_to_chem21_colour_flag(
                self.exported_from_js.get("Yield Sustainability")
            ),
            "conversion_flag": ReactionDataReplacement.css_classes_to_chem21_colour_flag(
                self.exported_from_js.get("Conversion Sustainability")
            ),
            "selectivity_flag": ReactionDataReplacement.css_classes_to_chem21_colour_flag(
    ...
    def get_physical_forms(self, component):
        ...
        return [
            ReactionDataReplacement.physical_forms(x)
    ...
    def get_metadata_access_methods(self) -> Dict:
        ...
        return {
            ...
            "sustainability_data": self.read_sustainability_flags  # [{'batch_or_flow': {'value': 'batch', 'flag': 1 or 'green'}]
